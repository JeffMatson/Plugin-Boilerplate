...
var project = 'plugin-boilerplate', // Project name, used for build zip.
...
gulp.task('uglify', function() {
    return gulp.src(['./assets/js/*.js', './assets/bower_components/**/dist/*.js', '!./assets/js/*.min.js'])
        .pipe(gulp.dest('./assets/js'))
        .pipe(rename({
            suffix: '.min'
        }))
...
gulp.task('bower', function() {
    return gulp.src(mainBowerFiles(), { base: './assets/bower_components' })
        .pipe(gulp.dest('./assets/vendor'));
});

gulp.task('bower_js', function() {
    return gulp.src(['./assets/bower_components/**/dist/*.js'])
        .pipe(gulp.dest('./assets/js'))
        .pipe(notify({ message: 'Vendor scripts task complete', onLast: true }));
});

gulp.task('bower_css', function() {
    return gulp.src(['./assets/bower_components/**/dist/*.css'])
        .pipe(gulp.dest('./assets/css'))
        .pipe(notify({ message: 'Vendor scripts task complete', onLast: true }));
});
...
gulp.task('build', function(cb) {
    runSequence('webpack', 'cleanup', 'vendorsJs', 'scriptsJs', 'buildFiles', 'buildImages', 'buildZip', 'cleanupFinal', cb);
});


// Watch Task
gulp.task('default', ['webpack', 'uglify', 'bower', 'images'], function() {
